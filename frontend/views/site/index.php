...
<?php $veh=  frontend\models\Vehicle::find()->orderBy(['id'=>SORT_DESC,])->limit(10)->all();
            ...
            <li><a href="#">
                ...
                <span><img src="<?php echo Yii::getAlias('@web') ?>/designe/images/loc.jpg"><?= $vehs->location;?></span>
                </div>
        	...
        	<div class="container">
            	<div class="row">
                	<div class="col-md-6">
                            ...
                            <?php $content= \backend\models\Content::find()->where(['id'=>1,'status'=>1])->all();
...
<a href="#" class="read_more_btn">Read More</a>
  ...
  <div class="container-fluid black_bg">
  		<div class="container">
        	<div class="row">
                    <?php $content= \backend\models\Content::find()->where(['id'=>2,'status'=>1])->all();
              foreach($content as $data){?>
            	<div class="col-md-4">
